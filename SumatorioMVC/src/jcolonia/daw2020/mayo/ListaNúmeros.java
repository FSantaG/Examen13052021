...
public class ListaNúmeros {
	 ...
	 */
	public ListaNúmeros() {
		setLista(new ArrayList<Double>(6));
	}
	 ...
	 */
	public static void add(double valor) throws SumatorioNumberException {
		comprobarRangoPermitido(valor);
		getLista().add(Math.copySign(valor, +0.0));
	}
	 ...
	 * @see #comprobarRangoPermitido(Double)
	 */
	public static void add(String entrada) throws SumatorioNumberException {
	 ...
	 */
	public static int getNúmSumandos() {
	...
	public ArrayList<String> toListaString() {
		ArrayList<String> listaTextos = new ArrayList<String>(getLista().size());
		String texto;
	...
	public String toString() {
		...
		for (int i = 0; i < getLista().size(); i++) {
			prefijo = (i + 1 == getLista().size() ? " + " : "   ");
			sbTexto.format(txtFormato, prefijo, getLista().get(i));
		}
	...
	public static void setLista(ArrayList<Double> lista) {
		ListaNúmeros.lista = lista;
	}
}
